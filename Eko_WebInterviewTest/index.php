	      ...
	      <div class="container">
	      	<div class="row">
	      		<div id="cta-title" class="col-sm-6 col-lg-5 col-lg-offset-1">
					...
					<p class="button-row">
				      	<a href="https://itunes.apple.com/us/app/loop-by-eko/id931539244?mt=8" target="itunes_store" class="btn btn-default btn-store">
				      		<img src="images/badge-store-ios.svg" height="30" width="30" alt="iTunes"/> App Store
				      	</a>
				      	
				      	<a href="https://play.google.com/store/apps/details?id=com.ekoapp.loop&amp;hl=en" target="_blank" class="btn btn-default btn-store pull-right">
				      		<img src="images/badge-store-play.svg" height="30" width="30" alt="GooglePlay"/> Play Store
				      	</a>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-5 padded-text">
						...
						<p class="button-row">
						<p>&nbsp;</p>
				     	<a href="https://itunes.apple.com/us/app/loop-by-eko/id931539244?mt=8" target="itunes_store" class="btn btn-default btn-store"> Download for Free
				      	</a>
				...
				<div class="row">
					...
					<div class="col-sm-4 padded-text">
						...
						<p>All Loops are archived for easy access.<br>Never lose track of commitments again.
							<p>&nbsp;</p>
							<p class="button-row">
				      			<a href="https://itunes.apple.com/us/app/loop-by-eko/id931539244?mt=8" target="itunes_store" class="btn btn-default btn-store3"> Get the App
				      			</a>
							</p>
					</div>
